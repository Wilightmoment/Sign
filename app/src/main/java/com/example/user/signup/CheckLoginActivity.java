...
public class CheckLoginActivity extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            link = "http://140.130.33.142/checkLogin.php" + data;
        ...
        if (jsonStr != null) {
            ...
            try {
                ...
                if (query_result.equals("SUCCESS")) {
                    ...
                    Toast.makeText(context, "會員LOGIN成功"+username, Toast.LENGTH_SHORT).show();

                }  else if (query_result.equals("FAILURE")) {

                    Toast.makeText(context, "會員LOGIN失敗", Toast.LENGTH_SHORT).show();
